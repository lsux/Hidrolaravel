...
<!-- Testimonial End -->
    ...
    <script src="../../resources/js/lib/easing/easing.min.js"></script>
    <script src="../../resources/js/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="../../resources/js/lib/tempusdominus/js/moment.min.js"></script>
    <script src="../../resources/js/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="../../resources/js/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="../../resources/js/mail/jqBootstrapValidation.min.js"></script>
    <script src="../../resources/js/mail/contact.js"></script>
